...
if (__VLS_ctx.isLoading) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.img)({
        src: (__VLS_ctx.service.image),
        alt: (__VLS_ctx.service.title),
        ...{ class: "w-full" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "text-[#7a7a7a] text-[16px] pt-[50px]" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.h1, __VLS_intrinsicElements.h1)({
        ...{ class: "text-3xl font-bold text-[#121f38] mb-4" },
    });
...
/** @type {__VLS_StyleScopedClasses['pt-[50px]']} */ ;
...
//# sourceMappingURL=ServiceDetails.vue.js.map